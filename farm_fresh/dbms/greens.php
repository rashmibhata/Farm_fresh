...
$sql1="select pid as pid, pname as name,qty as quantity,unitprice as price,taluk as taluk,district as district from seller S,produces P where S.sid=P.sid and P.category='Greens'";
