    ...
    <div class="page-content">
        <div class="form-v7-content">
            ...
            <form class="form-detail" action="" method="post" id="myform">
                <div class="form-row">
                    ...
                    <input type="text" name="bid" id="bid" class="input-text" required>
                </div>
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <input type="password" name="password" id="password" class="input-text" onchange="validate(this.value)" required placeholder="Create password">
                ...
                <div class="form-row">
                    ...
                    <input type="number" name="phno" id="username" required class="input-text">
                </div>
                <div class="form-row">
                    <label for="username">ADHAAR NUMBER</label>
                    <input type="number" name="adhar" id="username" required class="input-text" placeholder="XXXX-XXXX-XXXX">
                </div>
                <div class="form-row">
                    <label for="username">ADDRESS:</label><br><br>
                    <label for="username">STREET/LANE/DOOR NUMBER</label>
                    <input type="number" name="strno" id="username" class="input-text" required>
                    <label for="username">HOBLI</label>
                    <input type="text" name="hobli" id="username" class="input-text" required>
                    <label for="username">TALUK</label>
                    <input type="text" name="taluk" id="username" class="input-text" required>
                    <label for="username">DISTRICT</label>
                    <input type="text" name="district" id="username" class="input-text" required>
                    <label for="username">PINCODE</label>
                    <input type="text" name="pincode" id="username" class="input-text" required>
                </div>
                <div class="form-row-last">
                    <input type="submit" name="submit" class="register" value="Register">
                    <p>Or<a href="blogin.php">Sign in</a></p>
                </div>
            </form>
        </div>
        <script>
        ...
        <?php
           ...
           if(isset($_POST['submit']))
           {
               ...
               $sql1="select * from buyer where bid='".$bid."'";
               ...
               if($pass!=$cpass)
               {
                ...
                $sql4="insert into buyer values('".$bid."','".$name."','".$email."','".$pass."',".$phno.",".$adhar.",".$strtno.",'".$hobli."','".$taluk."','".$district."',".$pincode.")";
                $res4=$conn->query($sql4);
                if($res4)
                {
                    echo"<script>alert('Successfully Registered')</script>";
                    echo "<script type='text/javascript'> window.location='blogin.php'; </script>";
                }
