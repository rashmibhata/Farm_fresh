...
$sql1="select produces.pname as pname,orders.qty as qty,orders.price as price,orders.odate as odate,orders.bid as bid from orders,produces where orders.pid=produces.pid and produces.sid='".$sid."'";
...
if(mysqli_num_rows($res1)==0)
{
    ...
    while($row1=mysqli_fetch_assoc($res1))
    {
       $pname=$row1['pname'];
        ...
        $sql2="select name,phno from buyer where bid='".$bid."'";
