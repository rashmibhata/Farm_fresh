...
<body>
    <div class="blogin">
        ...
        <form action="" method="post">
            ...
            <h4 style="color: #fff;">New User?<a href="sregister.php" style="color: rgb(9, 179, 247);">Register!</a></h4>
        </form>
    </div>
</body>
...
<!-- class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  $sql1="select * from seller where sid='".$sid."' and password='".$pass."'";
  ...
  else
  {
    ...
    header("location:sellerpage.php?id=$sid");
  }
